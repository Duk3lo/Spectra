package org.astral.spectra.hytale.commands;

import com.hypixel.hytale.server.core.command.system.basecommands.AbstractCommandCollection;
import org.astral.spectra.hytale.commands.command.*;
import org.jetbrains.annotations.NotNull;

public final class SpectraCommands extends AbstractCommandCollection {
    public SpectraCommands(@NotNull String name, @NotNull String description) {
