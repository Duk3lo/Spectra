package org.astral.spectra.hytale.to_asset;
...
public final class AssetPackBuilder {
    ...
    public record AssetPackConfig(
        ...
        public AssetPackConfig {
            if (packFolderName == null || packFolderName.isBlank()) packFolderName = "SpectraAssets";
            if (groupName == null || groupName.isBlank()) groupName = "Astral";
            if (packName == null || packName.isBlank()) packName = "SpectraAssets";
            if (authorName == null || authorName.isBlank()) authorName = "Duk3lo";
            if (description == null || description.isBlank()) {
                description = "asset Spectra";
            }
        }
    }
