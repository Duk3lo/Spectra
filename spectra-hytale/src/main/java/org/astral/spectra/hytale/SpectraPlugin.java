package org.astral.spectra.hytale;
...
import org.astral.spectra.hytale.commands.SpectraCommands;
import org.astral.spectra.hytale.configuration.AudioConfigAdapter;
import org.astral.spectra.hytale.configuration.ConfigLoader;
import org.astral.spectra.hytale.configuration.VisualsConfig;
import org.astral.spectra.hytale.events.SpectraEvents;
import org.astral.spectra.hytale.loggin.PluginLogger;
...
public final class SpectraPlugin extends JavaPlugin {
    ...
    public SpectraPlugin(@NotNull JavaPluginInit init) {
        super(init);
    ...
    protected void setup() {
        ...
        getCommandRegistry().registerCommand(new SpectraCommands(command, "Using for Audios Analyzer"));
        SpectraEvents.RegisterAll();
    ...
    public static SpectraPlugin getInstance() {
        return instance;
    }
